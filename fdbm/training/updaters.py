...
def get_scheduler(optimizer, scheduler_name: str = 'plateau', scheduler_mode: str = 'min', 
...
def get_ema(model, decay_rate: float):
    if decay_rate is None:
        return None
    ema = ExponentialMovingAverage(parameters=model.parameters(), decay=decay_rate)
    return ema
