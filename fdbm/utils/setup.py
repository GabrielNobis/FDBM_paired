...
from fdbm.utils.definitions import IS_CLUSTER, EXP_DIR, CLUSTER_EXP_DIR, WANDB_ENTITY
...
def parse_train_args(cmd_args=None):
    ...
    parser.add_argument("--method", default="fdbm", choices=["fdbm","abm","sbalign"])
   ...
   # wandb
    ...
    parser.add_argument("--fine_tune_last_n_epochs", default=100, type=int, help="Number of training epochs.")
    ...
    parser.add_argument("--grad_clip_value", default=1.0, type=float, help="Gradient clipping max value")
...
def parse_conf_train_args(cmd_args=None):
   ...
   # wandb
    ...
    parser.add_argument("--H", default=0.2, type=float, help="Hurst index")
    parser.add_argument("--K", default=5, type=int, help="Number of augmenting processes")
    parser.add_argument("--norm", default=False, type=str2bool, help="Normalize variance according to max_diffusivity")
